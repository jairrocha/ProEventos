...
{
    public partial class adicionandoindentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Titulo = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    Descricao = table.Column<string>(type: "TEXT", nullable: true),
                    Funcao = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
